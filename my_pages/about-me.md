...
| Cloud & Infrastructure              | Security Engineering                    | Automation & Code        |
| ------------------------------------ | --------------------------------------- | ------------------------ |
| AWS (EC2, S3, VPC, Lambda)          | IAM & Identity Governance (CIEM)       | Python (Boto3 Scripting) |
| Azure (Active Directory/Entra ID)    | Vulnerability Management                | Terraform (IaC)          |
| Docker & Kubernetes                  | SIEM (Splunk, Wazuh)                    | Linux & Bash Scripting   |
| Windows Server Administration       | Network Security (WAF, Firewalls)      | Git & CI/CD Pipelines    |
