...
1. **CompTIA Security+:** Started here for foundational knowledge
2. **Home Lab:** Built a virtual environment to practice
3. **TryHackMe:** Hands-on labs and challenges
4. **Networking:** Joined local cybersecurity meetups
5. **Specialization:** Focused on incident response
