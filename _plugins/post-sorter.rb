...
Jekyll::Hooks.register :site, :post_read do |site|
  begin
    ...
    # If sorting fails, just continue with default order
    # This ensures the build doesn't fail due to sorting issues
    Jekyll.logger.warn "PostSorter", "Could not sort posts: #{e.message}"
  end
end
